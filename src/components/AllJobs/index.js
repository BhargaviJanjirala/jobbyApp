...
class AllJobs extends Component {
  ...
  onGetProfileDetails = async () => {
    ...
    if (responseProfile.ok === true) {
      ...
      const profileUpdatedData = profileFetchedData.map(eachItem => ({
      ...
      this.setState({
        profileData: profileUpdatedData,
  ...
  onGetJobDetails = async () => {
    ...
    if (responseJobs.ok === true) {
      ...
      const jobsUpdatedData = jobsFetchedData.jobs.map(eachItem => ({
